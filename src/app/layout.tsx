...
export const metadata: Metadata = {
  title: "Jardel Campos' portfolio | Fullstack Developer",
  ...
  keywords: 'portfolio, web development, web projects, front end, react, css, html, next.js, sass, tailwind, fullstack, front end, backend',
}
